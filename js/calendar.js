...
$(function () {
    $(".times").click(function () {
			$(".times").removeClass('changeBackground');
...
//open source code for calednar display
...
app.controller('dateTimeCtrl', function ($scope) {
	...
	ctrl.updateDate = function (newdate) {
		...
		//this is where we check out clinicians google calendar
    ...
    return {
        ...
        link: function (scope, element, attrs, ctrl, transclude) {
			...
			////////////////////////
				...
				//this might actually happen above
